# Accessible-Insulin-Pen-Redesign-Data-Driven-Analysis-
This project looks at medical device failures and how design impacts usability, and applies that to redesign an insulin pen for better accessibility.
...
Design issues can make devices harder to hold, control, and use correctly. This is especially a problem for users with motor impairments, like tremors, because it can reduce independence and increase the chance of errors during use.
...
The goal was to reduce the need for fine motor control and make the device easier to use independently. In my redesign I included a tapered shape to create a natural grip area, a textured silicone surface to prevent slipping, and a magnetic cap to reduce the need for twisting.

# Design Prototype

<img width="1920" height="1080" alt="Untitled design" src="https://github.com/user-attachments/assets/b4fcdd7a-e5c0-4f7c-a27e-0058b5d34efb" />

# Design Considerations

The added grip and materials may make the device slightly bigger and more expensive. However, this trade-off improves usability and stability, especially for users with limited motor control.
